 ...
 * Generated at: 2020-01-22 05:17:37 UTC
...
public final class boardInsert_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/board/../common/header.jsp", Long.valueOf(1579072783968L));
    _jspx_dependants.put("/WEB-INF/views/board/../common/footer.jsp", Long.valueOf(1579065557438L));
    _jspx_dependants.put("/WEB-INF/views/board/../common/nav.jsp", Long.valueOf(1579587148852L));
  }
...
if(msg != null){
 ...
 if(loginMember == null) {
      ...
      out.write("\t\t\t\t  <!-- enctype : 여러개의 파일 업로드시 반드시 필요 -->\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t- input 요소에 사용 가능\r\n");
      out.write("\t\t\t\t\t- input 요소 하나에 둘 이상의 값을 입력 할 수 있음을 명시\r\n");
      out.write("\t\t\t\t -->\r\n");
      out.write("\t\t\t\t\t<input type=\"file\" id=\"img1\" \r\n");
      out.write("\t\t\t\t\t\tname=\"img1\" onchange=\"LoadImg(this,1)\"> \r\n");
      out.write("\t\t\t\t\t\t<!-- file 타입의 onchange : 파일 경로가 변경됐을 때  -->\r\n");
      out.write("\t\t\t\t\t\t<input type=\"file\" id=\"img2\" multiple=\"multiple\"\r\n");
      out.write("\t\t\t\t\t\tname=\"img2\" onchange=\"LoadImg(this,2)\"> \r\n");
      out.write("\t\t\t\t\t\t<input type=\"file\" id=\"img3\" multiple=\"multiple\"\r\n");
      out.write("\t\t\t\t\t\tname=\"img3\" onchange=\"LoadImg(this,3)\"> \r\n");
      out.write("\t\t\t\t\t\t<input type=\"file\" id=\"img4\" multiple=\"multiple\"\r\n");
      ...
      out.write("\t\t\t// value.files이라는 배열이 있고, value.files[0] 에 값이 있는지\r\n");
      out.write("\t\t\t// --> 파일이 선택이 된 경우\r\n");
      out.write("\t\t\t// ---> 경로만 읽어들이는 상태\r\n");
      out.write("\t    \tif(value.files && value.files[0]){\r\n");
      out.write("\t    \t\tvar reader = new FileReader();\r\n");
      out.write("\t    \t\t// ---> 브라우저 위에 filereader객체가 올라옴\r\n");
      out.write("\t    \t\treader.onload = function(e){\r\n");
      out.write("\t    \t\t\tswitch(num){\r\n");
      out.write("\t    \t\t\tcase 1 : $(\"#titleImg\").prop(\"src\",e.target.result);break;\r\n");
      out.write("\t    \t\t\t// reader.onload : 파일을 다 읽어들이면 파일 경로를 리턴함\r\n");
      out.write("\t    \t\t\t// => e.target : 읽어들인 파일의 경로가 들어있음\r\n");
      out.write("\t    \t\t\t// e : reader.onload 이벤트 \r\n");
