 ...
 * Generated at: 2020-01-21 02:32:26 UTC
...
public final class noticeList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/notice/../common/footer.jsp", Long.valueOf(1579065557438L));
    _jspx_dependants.put("/WEB-INF/views/notice/../common/header.jsp", Long.valueOf(1579072783968L));
    _jspx_dependants.put("/WEB-INF/views/notice/../common/nav.jsp", Long.valueOf(1579570112563L));
  }
...
if(msg != null){
 ...
 if(loginMember == null) {
      ...
      out.write("        </li>\r\n");
      out.write("        <li class=\"nav-item col-md text-center\">\r\n");
      out.write("          <a class=\"nav-link\" href=\"href=\"");
      out.print(request.getContextPath());
...
if(loginMember != null && loginMember.getMemberGrade().equals("A")){ 
      ...
      out.print( searchKey);
      out.write("\";\r\n");
      out.write("\t\t\t\t\t\t/* java의 String 값을 jquery에서도 String으로 사용하기 위해서는 \"\" 리터럴로 문자라고 표시필요\" */\r\n");
      ...
      out.write("\t\t\t\t// tr 아래 td들이 배열로 반환됨\r\n");
      out.write("\t\t\t\t// td들 중 0번째 인덱스의 text만 얻어옴\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t// 쿼리스트링을 이용하여 GET방식으로 글번호를 server로 전달\r\n");
      out.write("\t\t\t\t// get방식일때 주소 뒤에 붙는 요소들\r\n");
      out.write("\t\t\t\tlocation.href=\"");
      out.print( request.getContextPath());
      out.write("/notice/detail?no=\"+ noticeNo;\r\n");
      out.write("\t\t\t\t\t\t// ? : get방식으로 전달되는 파라미터들을 넣을 수 있음\r\n");
      out.write("\t\t\t\t\r\n");
