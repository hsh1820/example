 ...
 * Generated at: 2020-01-14 08:45:56 UTC
...
public final class mypage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/member/sideMenu.jsp", Long.valueOf(1578978823953L));
 ...
 if(loginMember == null) {
      ...
      out.write("\t\t\t\t\t\t\t\t/* $.each(배열이나 객체, function(){} ); \r\n");
      out.write("\t\t\t\t\t\t\t\t\titem : 현재 접근하고 있는 요소\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t요소 자체가 들어가있음 <option>010</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\toption : input태그가 아니므로 값에 접근(수정.조회)할 때 \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t .val()이 아니라 .text()를 사용함 \r\n");
      out.write("\t\t\t\t\t\t\t\t*/\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t\t\t\t\t\t<hr class=\"mb-4\">\r\n");
      out.write("\t\t\t\t\t\t<button class=\"btn btn-primary btn-lg btn-block\" type=\"submit\" href=\"");
      out.print( request.getContextPath() );
      out.write("/member/updateMember.do\">수정</button>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
