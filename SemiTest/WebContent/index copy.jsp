                            ...
                            <div class="col-xl-3 col-lg-3 d-none d-lg-block">
                                <div class="Appointment">
                                    ...
                                    <% if(loginMember == null) {%>                                     
										...
										class="btn btn-sm btn-outline-secondary" data-toggle="modal">sign-in</a>
										<div class="modal fade" id="modal-container-120930" role="dialog"
					aria-labelledby="myModalLabel" aria-hidden="true">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="myModalLabel">login modal</h5>
							...
							<div class="modal-body">
								...
								action="<%=request.getContextPath()%>/member/login.do" onsubmit="return loginValidate();">
									<input type="text" class="form-control" id="memberId" name="memberId"
										placeholder="ID"> <br> 
									<input type="password" class="form-control" id="memberPwd" name="memberPwd"
										placeholder="password"> <br>
									<div class="checkbox mb-3">
										<label> <input type="checkbox"> ID save
										</label>
									</div>
