 ...
 * Generated at: 2020-01-23 08:02:29 UTC
...
if(msg != null){
 ...
 if(loginMember != null && (board.getBoardWriter().equals(loginMember.getMemberId()))) {
      ...
      out.write("\t\t\tvar fNo = $(this).next().val();/* next() :형제관계의 다음 요소 == input태그 */\r\n");
      ...
      out.write("\t\t\t// 로그인 된사람만 댓글을 쓸 수 있도록 하고 팝업창을 띄우기 위하여 초기화 안함\r\n");
 ...
 if(loginMember == null){
      ...
      out.write("\t\t\t\t\ttype : \"post\", // 문자셋 인코딩은 필터해둠\r\n");
      out.write("\t\t\t\t\tdata : {writer:writer, content:content, boardNo:boardNo},\r\n");
      out.write("\t\t\t\t\tsuccess : function(result){\r\n");
      out.write("\t\t\t\t\t\t// success : forward/redirect 했을 때의 응답이 담겨서옴\r\n");
      ...
      out.write("\t\t\t\t// 응답 데이터 형태 : json으로 전달받을 것이라는 의미\r\n");
      out.write("\t\t\t\tdata : {boardNo:boardNo},\r\n");
      out.write("\t\t\t\t// 전달하려는 타입 == 요청한 데이터\r\n");
      out.write("\t\t\t\tsuccess : function(rList){\r\n");
      out.write("\t\t\t\t\t// 성공하면 반환받을 결과물이 댓글 리스트\r\n");
