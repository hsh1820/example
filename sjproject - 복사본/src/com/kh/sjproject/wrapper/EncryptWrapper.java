...
public class EncryptWrapper extends HttpServletRequestWrapper{
	...
	// 반드시 명시적으로 HttpSerlvetRequest를 매개변수로 하는 생성자 작성이 필수다.
	...
	public static String getSha512(String pwd) {
		...
		try {
			...
			// 지정된 알고리즘을 사용해  MessageDigest 객체를 작성하여 반환한다.
		...
		// 암호화를 진행하기 위해서는 
		// 전달받은 문자열(비밀버호)를 바이트 배열로 변환해야 한다.
		...
		// java.util.Base64 인코더를 이용해서 암호화된 바이트 배열을 
		// 인코딩해서 문자열로 출력한다.
