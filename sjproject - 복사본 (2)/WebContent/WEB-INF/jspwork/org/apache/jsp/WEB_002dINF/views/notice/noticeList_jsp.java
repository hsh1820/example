 ...
 * Generated at: 2020-01-24 09:48:19 UTC
...
public final class noticeList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/notice/../common/footer.jsp", Long.valueOf(1578635196000L));
    _jspx_dependants.put("/WEB-INF/views/notice/../common/header.jsp", Long.valueOf(1579072774000L));
    _jspx_dependants.put("/WEB-INF/views/notice/../common/nav.jsp", Long.valueOf(1579570864000L));
  }
 ...
 if(loginMember!=null && loginMember.getMemberGrade().equals("A")) { 
      ...
      out.write("\t                </select>\r\n");
      out.write("\t                <input name=\"searchValue\" type=\"text\" class=\"form-control\" style=\"width:25%; display: inline-block;\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t// 선택했던 select 유지\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t            \t\t\t\r\n");
      out.write("\t\t\t            \t$(\"input[name=searchValue]\").val(searchValue); // 이전 검색어 유지\r\n");
      out.write("\t\t\t            \t\t\t\r\n");
      out.write("\t            \t\t\t});\r\n");
      out.write("\t            \t\t}\r\n");
      out.write("\t            \t});\r\n");
