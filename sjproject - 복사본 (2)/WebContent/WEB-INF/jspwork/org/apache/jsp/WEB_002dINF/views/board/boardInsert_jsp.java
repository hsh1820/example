 ...
 * Generated at: 2020-01-24 10:09:56 UTC
...
public final class boardInsert_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/board/../common/header.jsp", Long.valueOf(1579072774000L));
    _jspx_dependants.put("/WEB-INF/views/board/../common/footer.jsp", Long.valueOf(1578635196000L));
    _jspx_dependants.put("/WEB-INF/views/board/../common/nav.jsp", Long.valueOf(1579570864000L));
  }
 ...
 if(loginMember==null) { 
      ...
      out.write("\t\t\t\t<!-- enctype=\"multipart/form-data\" : 파일업로드시 꼭 필요! -->\r\n");
      out.write("\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\tmultiple=\"multiple\" ->파일 여러개 선택 가능\r\n");
      out.write("\t\t\t\t\t-->\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<input type=\"file\" id=\"img1\"\r\n");
      out.write("\t\t\t\t\t\tname=\"img1\" onchange=\"LoadImg(this,1)\"> <input\r\n");
      out.write("\t\t\t\t\t\ttype=\"file\" id=\"img2\" \r\n");
      out.write("\t\t\t\t\t\tname=\"img2\" onchange=\"LoadImg(this,2)\"> <input\r\n");
      out.write("\t\t\t\t\t\ttype=\"file\" id=\"img3\" \r\n");
      out.write("\t\t\t\t\t\tname=\"img3\" onchange=\"LoadImg(this,3)\"> <input\r\n");
      out.write("\t\t\t\t\t\ttype=\"file\" id=\"img4\" \r\n");
      ...
      out.write("\t    \t\r\n");
      out.write("\t    \t// 파일 업로드시 업로드된 파일의 경로는\r\n");
      out.write("\t    \t// 해당 요소에 files라는 배열이 생성되면 저장됨\r\n");
      out.write("\t    \tif(value.files && value.files[0]) // files라는 배열이 있고, 0번째 인덱스에 값이 있냐?\r\n");
      ...
      out.write("\t    \t\t// + base64 인코딩된 경로를 반환 (2진법 데이터를 64진법으로 바꾼다.)\r\n");
